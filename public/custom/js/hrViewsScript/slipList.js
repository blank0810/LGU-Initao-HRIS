var tbody = $("#slip-list-table tbody");
...
var slipStatus = "Approved";

var slipStatusClass = "";

if (slipStatus === "Approved") {
    slipStatusClass = "success";
} else if (slipStatus === "Pending") {
    slipStatusClass = "secondary";
} else if (slipStatus === "Rejected") {
    slipStatusClass = "danger";
}
