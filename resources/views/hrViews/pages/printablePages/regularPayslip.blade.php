...
<head>
  ...
  <style>
    ...
    @media print {
      ...
      /* Ensure the watermark is applied to all pages */
    body::after {
        content: '';
        position: fixed; /* Use fixed to ensure it appears on all pages */
        top: 0;
        left: 0;
        background-image: url('{{ asset('images/resize-logo.png') }}');
        background-size: 500px;
        ...
        <div class="invoice-column">
          ...
          <div class="row">
            <div class="col text-muted">
              <h6 style="color: red">NOTE: <span><em> Unauthorized access to this document is subject to legal penalties. Only authorized personnel are 
                permitted to view and handle this document.</em></span></h6>
            </div>
          </div>
